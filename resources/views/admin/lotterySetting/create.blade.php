    ...
    <div class="smart-widget widget-purple">
		<div class="smart-widget-inner">
			<div class="smart-widget-body">
                {{ Form::open(array('route' => ['setting.store'], 'class'=>'form-horizontal', 'method'=>'POST', 'id'=>'post-form')) }}
					<div class="form-group">
						<label for="winning_odds" class="col-lg-2 control-label">中奖几率</label>
						<div class="col-lg-10">
							<input value="" name="winning_odds" type="text" class="form-control" id="winning_odds" placeholder="请输入中奖几率/万分比">
                    ...
                    <div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" value="" name="max_num" class="form-control" id="max_num" placeholder="请输入最大数量">
                    ...
                    <div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" value="" name="lottery_date" class="form-control datepicker" id="lottery_date" placeholder="请输入抽奖日期">
