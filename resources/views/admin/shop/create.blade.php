    ...
    <div class="smart-widget widget-purple">
		<div class="smart-widget-inner">
			<div class="smart-widget-body">
                {{ Form::open(array('route' => ['shop.store'], 'class'=>'form-horizontal', 'method'=>'POST', 'id'=>'post-form')) }}
					<div class="form-group">
						<label for="name" class="col-lg-2 control-label">店铺名</label>
						<div class="col-lg-10">
							<input value="" name="name" type="text" class="form-control" id="name" placeholder="请输入店铺名">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" value="" name="code" class="form-control" id="code" placeholder="请输入唯一编号">
                    ...
                    <div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" value="" name="address" class="form-control" id="address" placeholder="请输入详细地址">
                    ...
                    <div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" value="" name="contact_person" class="form-control" id="contact_person" placeholder="请输入联系人">
                    ...
                    <div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" value="" name="contact_mobile" class="form-control" id="contact_mobile" placeholder="请输入联系电话">
                    ...
                    <div class="form-group">
						...
						<div class="col-lg-10">
                            <textarea name="oil_info" class="form-control" id="oil_info" placeholder="请输入机油信息"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input value="" name="booked_limit_num" type="text" class="form-control" id="name" placeholder="请输入预约每天限制数量">
                            <label class="help-block" for="" id="help-name"></label>
                        </div><!-- /.col -->
                    </div><!-- /form-group -->
					<div class="form-group">
